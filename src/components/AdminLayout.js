...
import { ChartBar, Package, Motorcycle, Storefront, SignOut } from '@phosphor-icons/react';
...
export function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { path: '/admin/couriers', label: 'Kuryeler', icon: Motorcycle },
    { path: '/admin/restaurants', label: 'Restoranlar', icon: Storefront },
    { path: '/admin/analytics', label: 'Analitik', icon: ChartBar },
  ];
